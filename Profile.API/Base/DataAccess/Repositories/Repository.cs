...
namespace Profile.Base.DataAccess
{
    public class Repository<T> : IRepository<T> where T : class, IBaseEntity
    {
        ...
        public async Task<BasePaginatedViewModel<T>> GetPaginatedList(int offset, int limit, Expression<Func<T, bool>>? predicate = null, params Expression<Func<T, object>>[] includeProperties)
        {
            int totalCount;
            IEnumerable<T> data;
            IQueryable<T> query = _context.Set<T>();
            ...
            return new BasePaginatedViewModel<T>
            {
                Offset = offset,
                Limit = limit,
